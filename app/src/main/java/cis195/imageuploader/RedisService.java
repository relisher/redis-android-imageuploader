...
class RedisService {
    ...
    interface Service {
        ...
        @PUT("SET/{key}")
        Call<SetResponse> makePost(@Path("key") String key, @Body ListItem body);
    ...
    static Service getService() {
        if (service == null) {
            ...
            Retrofit retrofit = new Retrofit.Builder()
                    .baseUrl("http://ec2-34-197-228-35.compute-1.amazonaws.com/7bfabef848a997c6bcfd43595e43600d/")
